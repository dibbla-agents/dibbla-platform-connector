---
name: dibbla-setup
description: Set up, connect, troubleshoot or revoke the Dibbla connector (MCP). Use this when the platform_* tools are missing, when a connection is refused, when a write answers INSUFFICIENT_SCOPE, when something is reported as NOT_FOUND in the wrong organization, or when somebody asks how to install, self-host or revoke Dibbla.
---
